        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 md:gap-6 app-page-gutter pt-5 pb-4 border-b border-border">
          <div className="min-w-0">
            ...
            <p className="mt-1.5 text-[13px] md:text-[14px] text-muted-foreground max-w-2xl leading-relaxed">
              Per-employee leave ledger and team calendar. Personal leave is recorded per employee; team blocks and individual leave both appear on the calendar — +{PACING_LEAVE_HOURS_PER_DAY}h/workday in Weekly Pacing (half day +{PACING_LEAVE_HOURS_PER_DAY / 2}h).
            </p>
          </div>
