...
export const SCORING_RULES_SUMMARY = [
  ...
  `Approved leave workdays credit +${PACING_LEAVE_HOURS_PER_DAY}h/day toward work hours (same as Weekly/Monthly Pacing) so composite score is not penalized for time off.`,
